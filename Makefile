...
all: \
	...
	public/bundle/portal.js \
	public/bundle/portal.css \
	export
...
clean:
	...
	cd public && rm -rf css/ images/ js/ bundle/ latest-change.txt patternlab-components/ patterns/ static/
	rm -rf export/*
...
public/bundle/portal.js public/bundle/portal.css: $(WEBPACK) webpack.config.js source-bundle/style.scss $(WP_SOURCES)
	$(WEBPACK)

.PHONY: export
export: public/latest-change.txt public/bundle/portal.js public/bundle/portal.css
	$(PATTERNLAB) --export
	cp -a public/bundle export/
